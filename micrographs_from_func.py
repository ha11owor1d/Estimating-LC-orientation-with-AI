...
DirectorFieldInitializer2 = DirectorField.TwistDirector(name=img_name, q=2*np.pi/5, axis='x', out_of_plane=2.0)                 # 2. Twist: Rotates along an axis
...
nx = lambda x,y,z: nx2(x+4,y,z)+nx4(x,y,z)
ny = lambda x,y,z: ny2(x+4,y,z)+ny4(x,y,z)
nz = lambda x,y,z: nz2(x+4,y,z)+nz4(x,y,z)
